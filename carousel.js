class Carousel {
  ...
  _initListeners () {
    ...
    this.slidesContainer.addEventListener('mouseenter', this.pausePlayHandler.bind(this))
    this.slidesContainer.addEventListener('mouseleave', this.pausePlayHandler.bind(this))
  }
